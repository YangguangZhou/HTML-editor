...
function openDialog() {
    ...
    dialogBG.style["zIndex"] = dialog.style["zIndex"] = "2021";
...
function loaded() {
    ...
    │ Blog                         https://blog.jerryz.com.cn │
    │ GitHub                https://github.com/YangguangZhou │
    │                                                        │
    ├────────────────────────────────────────────────────────┤
    │                                                        │
    │ MIT LICENSE                                            │
    │ Copyright © 2021 - 2022 Jerry Zhou                     │                │
    │                                                        │
    └────────────────────────────────────────────────────────┘
    `);
}
